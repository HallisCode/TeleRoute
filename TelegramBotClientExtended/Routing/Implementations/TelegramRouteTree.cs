    ...
    public class TelegramRouteTree : ITelegramRouteTree
    {
        ...
        public ITelegramRouteDescriptor? Resolve(Update update)
        {
            ...
            foreach (ITelegramRouteDescriptor routeDescriptor in Routings)
            {
                ...
                bool isAllowedTypeDefined = routeDescriptor.AllowedTypes is not null;
                ...
                bool isFilterTypeMatch = isFilterDefined && (routeDescriptor.Filter.AllowedTypes & updateType)
                    .Equals(updateType);
                ...
                bool isTypeMatch = isAllowedTypeDefined && (routeDescriptor.AllowedTypes & updateType)
                    .Equals(updateType);
